...
st.set_page_config(layout="wide", page_title="Sistema de Análise de Recursos")
...
""", unsafe_allow_html=True)
      ...
      styled_menu_button("btn_user", "person_add", "Cadastrar Usuário", "usuario")
...
<h2 style="display:flex;align-items:center;">
    <span class="material-icons" style="font-size:28px;color:#0d6efd;margin-right:8px;">directions_bus</span>
